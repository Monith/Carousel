...
1. How hard was it to do the first optional task for you? i.e. Photo tiles move, scale and rotate while user scrolls.
2. What is the best way to implement the sign in logic

### Video Walkthrough 

Here's a walkthrough of implemented user stories:

<img src='http://imgur.com/a/zGrqo' title='Video Walkthrough' width='' alt='Video Walkthrough' />
